...
vignette: >
  %\VignetteIndexEntry{Testing Protocol Companion to textNet Vignette}
...
old_acronyms <- find_intext_acronyms(old_new_text[[1]])
new_acronyms <- find_intext_acronyms(old_new_text[[2]])
