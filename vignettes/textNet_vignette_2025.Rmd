...
#download.file(URL, destfile = "inst/extdata/old.pdf", method="curl")

#URL <- "https://sgma.water.ca.gov/portal/service/gspdocument/download/9625"
#download.file(URL, destfile = "inst/extdata/new.pdf", method="curl")
...
old_new_parsed <- textNet::parse_text(
