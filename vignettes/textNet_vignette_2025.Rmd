...
```{r composite, fig.width=5,fig.height=5, fig.retina=2}
...
```{r step8b4, warning=F, message=F, fig.width=10,fig.height=8, fig.retina=2}
library(gridExtra)
library(ggplot2)
