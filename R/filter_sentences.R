...
#' @param case_sensitive Whether the token is required to have the specific casing used in the dictionary to count as a match. Defaults to FALSE.
...
filter_sentences <- function(file, filter = textNet::eng_words, 
                             percent_threshold = 40, case_sensitive = FALSE){
  # Input validation
